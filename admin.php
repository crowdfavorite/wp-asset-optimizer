	...
	public static function adminMenuCallback() {
		...
		<div class="wrap">
			<form method="post" action="" id="cf-asset-optimizer-settings" class="settings">
				<div class="col-left">
					<?php screen_icon(); ?><h2 class="main-head"><?php echo esc_html(__('CF Asset Optimizer')); ?></h2>
					<?php if (!empty($optimizations_enabled)) {  ?>
					<ul class="messages">
						<li>Congratulations, your site is faster now.</li>
					</ul>
					<?php } ?>
					<p class="mar-top main-descr"><a href="http://www.crowdfavorite.com">Crowd Favorite</a>'s <?php echo esc_html(__('Asset Optimizer takes all the separate CSS and JS files included in plugins and external add-ons, and compiles them into one file, helping your pages load faster.')); ?></p>
					<?php
