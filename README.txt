...
## Configuration
- Hit the homepage. This will cause the plugin to get a list of all styles/scripts used on this page.
- Hit other pages as well, if they are expected to use scripts that would not be included on the home page.
...
- *Note: Concatenated static filenames do not change unless the enqueued script/stylesheet handle for one of the concatenated files changes, or a file is added.*